...
Existem três tipos principais de sistemas fotovoltaicos. Cada um atende necessidades específicas e oferece vantagens diferentes para o seu perfil de consumo.
...
O sistema híbrido combina as características dos sistemas on-grid e off-grid. Ele é conectado à rede, mas também possui baterias de armazenamento. Isso permite utilizar os créditos na rede e ter reserva para situações de apagão. Esse modelo tem ganhado espaço no Brasil, especialmente após os casos de apagões em diversas regiões.

## Componentes de um sistema fotovoltaico

Um sistema fotovoltaico é composto por diversos elementos que trabalham em conjunto para gerar energia limpa e eficiente. Entender cada componente ajuda na hora de tomar decisões sobre investimento e manutenção.

### Painéis solares

Os painéis solares são o coração do sistema. Eles são compostos por células de silício que captam a radiação solar e a convertem em energia elétrica. Existem três tipos principais de células: monocristalinas, com eficiência entre 18% e 22%; policristalinas, com eficiência entre 15% e 18%; e filme fino, menos eficientes, mas com flexibilidade para aplicações específicas.

### Inversor solar

O inversor é responsável por converter a corrente contínua gerada pelos painéis em corrente alternada, utilizada pelos eletrodomésticos. Existem inversores string, os mais comuns e econômicos; microinversores, que permitem que cada painel opere independentemente; e inversores com otimizadores, que oferecem monitoramento individual dos painéis.
...
O processo de instalação segue etapas bem definidas que garantem a qualidade e a segurança do sistema. O estudo de viabilidade é a primeira etapa, com análise técnica e financeira do local. O projeto técnico é elaborado em seguida, incluindo diagramas e especificações dos componentes.

A aprovação na concessionária pode levar de 15 a 45 dias. A instalação física é rápida, geralmente de 1 a 3 dias para residências. A vistoria e ligação são realizadas pela concessionária, e o monitoramento começa imediatamente após a autorização. O prazo total, do primeiro contato até a ligação do sistema, pode variar de 30 a 90 dias.

## Legislação brasileira e regulamentação

A principal regulamentação da geração distribuída é a Norma ANEEL 482/2012, que estabelece as regras para a geração conectada à rede. Essa norma define as modalidades de geração distribuída e as regras para compensação de energia por meio de créditos. A ANEEL introduziu a minigeração distribuída, que permite sistemas de até 5 MW.

O Marco Legal da Geração Distribuída, sancionado em 2022, trouxe segurança jurídica ao setor, garantindo a manutenção do regime de compensação de energia por 35 anos para sistemas instalados até o início de 2023. Para instalação de sistemas residenciais de até 75 kW, não é necessária licença da prefeitura.

## Análise de payback e economia

O payback é o tempo necessário para que o investimento se pague. No Brasil, o payback médio de um sistema residencial varia de 4 a 7 anos, dependendo da região, do consumo e da tarifa da concessionária. Após o período de payback, o sistema continua gerando energia gratuitamente por mais 18 a 23 anos.

Quanto maior a tarifa da sua concessionária, menor será o payback do seu sistema. Para uma análise detalhada de custos, confira nosso post sobre financiamento de energia solar. A qualidade dos componentes também influencia diretamente a durabilidade e o desempenho ao longo dos anos.
